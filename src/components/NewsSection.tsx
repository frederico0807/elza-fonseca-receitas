  ...
  return <div className="space-y-6">
      ...
      <Card className="overflow-hidden border-rose-100 shadow-sm hover:shadow-md transition-shadow">
        <div className="relative">
          <img src="https://i.imgur.com/GN6vuxB.jpeg" alt="Sobremesas Saudáveis" className="w-full h-48 object-cover border-4 border-white rounded-t-lg shadow-md" />
        ...
        <CardContent className="bg-white">
          ...
          <Button onClick={() => handleUpsellClick('sobremesas-saudaveis')} className="w-full bg-rose-500 hover:bg-rose-600 text-white rounded-full py-3 font-medium">Saiba Mais!</Button>
        </CardContent>
      </Card>

      <Card className="overflow-hidden border-green-200 shadow-sm hover:shadow-md transition-shadow">
        <div className="relative">
          <img src="https://i.imgur.com/5fgkVxb.jpeg" alt="Monetizar com Doces" className="w-full h-48 object-cover border-4 border-white rounded-t-lg shadow-md" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent rounded-t-lg" />
        </div>
